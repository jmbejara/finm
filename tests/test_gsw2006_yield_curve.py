...
DATA_DIR = TESTS_DIR.parent / "src" / "finm" / "data"
FED_RES_DIR = DATA_DIR / "Federal_Reserve"
...
def test_fit_on_several_days():
    ...
    actual_all = finm.load_fed_yield_curve_all(data_dir=FED_RES_DIR)
    ...
    df_all = finm.load_CRSP_treasury_consolidated(data_dir=WRDS_DIR)
