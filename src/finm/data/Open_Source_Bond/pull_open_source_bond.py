...
def download_data(
    ...
    ----------
    url : str
        URL to the CSV file containing the data.
    csv : str
...
def load_data_into_dataframe(csv_path: Path, check_n_rows: bool = True):
    ...
    check_n_rows : bool
        Whether to check for minimum number of rows.

    Returns
    -------
    pd.DataFrame
        DataFrame containing the bond data.
    """
...
def load_treasury_returns(
    ...
    """
    Load treasury bond returns from a parquet file.
...
def load_corporate_bond_returns(
    ...
    """
    Load corporate bond returns from a parquet file.
    ...
    -------
    pd.DataFrame
        DataFrame containing the corporate bond returns data.
    """
